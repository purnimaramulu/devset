...
<div id="wrapper">
	...
	<form name="login-form" class="login-form" action="/loginvalidate" method="post">
		...
		<div class="content">
		<input name="username" type="text" class="input username" id="email" placeholder="Username" />
